...
export const SigninForm = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      dispatch(authSlice.actions.setGoogleToken(token));
    }
  ...
  return (
    <>
          ...
          {isLoading ? (
            ...
            <a href="http://localhost:3001/api/auth/google">
              ...
              <span>
                ...
                <Yellowletter>o</Yellowletter>
                <Blueletter>g</Blueletter>
                <Greenletter>l</Greenletter>
      ...
      {/* <button onClick={handleGoogleLocal}>Google log in</button> */}
      <a href="http://localhost:3001/api/auth/google">Google lon in</a>
    </>
  );
};
