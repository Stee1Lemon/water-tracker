...
`,Qi="yyyy",Zi="MMMM",Ji="d",eo=()=>{const{t:n}=ie(),e=z(Te),{waterForMonth:i=[]}=z(_i),o=z(Oe),t=z(We),{allAmountForDay:s=0}=z(Oe),[a,u]=g.useState(0),r=s/t*100,l=parseFloat(r).toFixed(0);g.useEffect(()=>{u(l)},[t,s,o,l]);const[p,d]=g.useState(new Date),[m,x]=g.useState(null),b=g.useRef(null),w=ei(p),h=ti(p),f=Jn({start:w,end:h});let y=[];i.length>0&&(y=i==null?void 0:i.reduce((M,v)=>(M[v.date]=v,M),{}));let E;e==="uk"?E=_(p,"LLLL",{locale:tn}):E=_(p,Zi);const S=_(p,Qi),A=()=>{const M=ni(p,1);d(M),Et(M,new Date)?x(null):x("prev")},k=()=>{const M=Zt(p,1);d(M),Et(M,new Date)?x(null):x("next")};return c.jsxs("div",{ref:b,children:[c.jsxs(qi,{children:[c.jsx(Xi,{children:n("month")}),c.jsxs(Yi,{children:[c.jsx(Ct,{onClick:A,active:m==="next",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${Y}#icon-pagination-arrow-prev`})})}),c.jsxs("span",{children:[E,", ",S]}),c.jsx(Ct,{onClick:k,active:m==="prev",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${Y}#icon-pagination-arrow-next`})})})]})]}),c.jsx(Ki,{children:f.map(M=>{const v=_(M,"d, MMMM"),C=y[v]||0,P=C?parseInt(C.percentageWater):0,V=C?C&&parseInt(C.percentageWater)>=100:!1;return c.jsx(Ui,{isConsumed:V,date:_(M,Ji),percentage:P,day:v,calendarRef:b,data:y,today:{todayWaterData:o,dailyNormaFullfilled:a}},v)})})]})},to=F("div")`
display: flex;
align-items: center;
column-gap:12px;
svg {
...
`,js=()=>{const{t:n}=ie(),e=z(Te),o=(z(We)/1e3).toFixed(1),[t,s]=g.useState(!1),a=()=>{s(!t)};return c.jsxs(Vs,{lang:e,children:[c.jsx(de,{children:n("dailyNormaModal.header")}),c.jsxs(Ns,{children:[c.jsxs("span",{children:[o," L"]}),c.jsx("button",{onClick:a,type:"button",children:n("dailyNormaModal.edit")})]}),c.jsx(Ps,{isOpen:t,onClose:a})]})},Ls=F("div")`
display: flex;
flex-direction:column;
row-gap:20px;
@media only screen and (min-width: 768px) {
...
`,iu="/water-tracker/assets/bottle-b9ff448c.png",su=()=>c.jsx(c.Fragment,{children:c.jsx(Qs,{children:c.jsxs(Qn,{children:[c.jsxs(Zs,{children:[c.jsxs(Js,{children:[c.jsxs(eu,{children:[c.jsx(js,{}),c.jsx("img",{src:iu,alt:"bg"})]}),c.jsx(Gs,{})]}),c.jsxs(nu,{children:[c.jsx(Cs,{}),c.jsx(eo,{})]})]}),c.jsx(tu,{children:c.jsx(Ks,{children:"Delete user"})})]})})});export{su as default};
