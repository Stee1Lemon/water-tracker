...
`,Be=n=>n.auth.user.waterRate,De=n=>n.water.today,_i=n=>n.water.month,Ui=({isConsumed:n,date:e,percentage:i,day:o,data:t,calendarRef:s,today:{todayWaterData:a,dailyNormaFullfilled:u}})=>{const r=z(Le),l=z(Be),[d,p]=g.useState(null),[v,x]=g.useState(null),b=g.useRef(null),y=f=>{b.current&&!b.current.contains(f.target)&&p(null)};g.useEffect(()=>(document.addEventListener("click",y),()=>{document.removeEventListener("click",y)}),[]);const m=f=>{if(p(w=>w===f?null:f),r==="uk"&&(f=_(f,"d, MMMM",{locale:tn})),f===_(new Date,"d, MMMM"))x({date:f,dailyNorm:(l/1e3).toFixed(1),totalWaterPortionsForDay:a.portionsOfWater?a.portionsOfWater.length:0,percentageWater:u});else{const w=t[f]||0;x({date:f,dailyNorm:w?w.dailyNorm:0,totalWaterPortionsForDay:w?w.totalWaterPortionsForDay:0,percentageWater:w?parseInt(w.percentageWater):0})}};return c.jsxs(Hi,{children:[c.jsx("div",{children:d&&c.jsx($i,{calendarRef:s,refData:b,waterData:v},o)}),c.jsx(zi,{ref:b,onClick:()=>m(o),isConsumed:n,children:e}),c.jsxs(Gi,{children:[i,"%"]})]})},Yi=M("div")`
margin-bottom: 16px;
display: flex;
...
`,Qi="yyyy",Zi="MMMM",Ji="d",eo=()=>{const{t:n}=re(),e=z(Le),{waterForMonth:i=[]}=z(_i),o=z(De),t=z(Be),{allAmountForDay:s=0}=z(De),[a,u]=g.useState(0),r=s/t*100,l=parseFloat(r).toFixed(0);g.useEffect(()=>{u(l)},[t,s,l]);const[d,p]=g.useState(new Date),[v,x]=g.useState(null),b=g.useRef(null),y=ei(d),m=ti(d),f=Jn({start:y,end:m});let E=[];i.length>0&&(E=i==null?void 0:i.reduce((S,h)=>(S[h.date]=h,S),{}));let w;e==="uk"?w=_(d,"LLLL",{locale:tn}):w=_(d,Zi);const O=_(d,Qi),I=()=>{const S=ni(d,1);p(S),Et(S,new Date)?x(null):x("prev")},C=()=>{const S=Zt(d,1);p(S),Et(S,new Date)?x(null):x("next")};return c.jsxs("div",{ref:b,children:[c.jsxs(Yi,{children:[c.jsx(Xi,{children:n("month")}),c.jsxs(qi,{children:[c.jsx(Ct,{onClick:I,active:v==="next",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${X}#icon-pagination-arrow-prev`})})}),c.jsxs("span",{children:[w,", ",O]}),c.jsx(Ct,{onClick:C,active:v==="prev",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${X}#icon-pagination-arrow-next`})})})]})]}),c.jsx(Ki,{children:f.map(S=>{const h=_(S,"d, MMMM"),A=E[h]||0,{date:P}=A;let j,V;return P===_(new Date,"d, MMMM")?(j=a,V=a>=100||!1):(j=A?parseInt(A.percentageWater):0,V=A?A&&parseInt(A.percentageWater)>=100:!1),c.jsx(Ui,{isConsumed:V,date:_(S,Ji),percentage:j,day:h,calendarRef:b,data:E,today:{todayWaterData:o,dailyNormaFullfilled:a}},h)})})]})},to=M("div")`
display: flex;
align-items: center;
column-gap:12px;
svg {
...
font-size: 12px;
line-height: 200%;
`,nn=({data:{amount:n,time:e}})=>c.jsxs(to,{children:[c.jsx("svg",{children:c.jsx("use",{href:`${X}#icon-glass`})}),c.jsxs(no,{children:[n," ml"]}),c.jsxs(io,{children:[e," AM"]})]});var on={exports:{}};(function(n){(function(e,i){n.exports=i(e)})(typeof He<"u"?He:typeof window<"u"?window:He,function(e){if(typeof e>"u"&&typeof e.document>"u")return!1;var i="Notiflix",o=`
...
left:5px;
  ...
  font-size: 12px;
  line-height: 120%;
`,Me=({label:n="",error:e,...i})=>c.jsxs(oo,{children:[n,c.jsx(ao,{...i}),e&&c.jsx(ro,{children:e})]}),ve=qt`
  padding: 10px 30px;
...
`;function ms({isOpen:n,onClose:e,selectedItemId:i}){const{t:o}=re(),t=Te(),s=z(it),a=async()=>{const u=_(new Date,"dd/MM/yyyy");await t(le.deleteWaterThunk({id:i})),await t(le.getTodayWaterThunk({date:u})),ce.Notify.success("The portion is removed"),e()};return c.jsx(Re,{isOpen:n,onClose:e,children:c.jsxs(cs,{children:[c.jsx(ut,{children:o("deleteEntryModal.header")}),c.jsx(lt,{onClick:e,children:c.jsx("svg",{children:c.jsx("use",{href:`${X}#icon-close`})})}),c.jsx(de,{children:o("deleteEntryModal.question")}),c.jsxs(ds,{children:[c.jsx(ps,{onClick:e,type:"button",children:o("deleteEntryModal.buttonCancel")}),c.jsx(fs,{disabled:s,onClick:a,type:"button",children:s?c.jsx(ct,{children:c.jsx(ot,{})}):o("deleteEntryModal.buttonDelete")})]})]})})}const hs=M("div")`
margin-bottom: 24px;
flex:1 0 auto;
`,gs=M("div")`
font-size: 24px;
...
`,Cs=()=>{const{t:n}=re(),{portionsOfWater:e}=z(De),[i,o]=g.useState(!1),[t,s]=g.useState(!1),[a,u]=g.useState(!1),[r,l]=g.useState(null),d=()=>{o(!0),s(!1),u(!1),l(null)},p=b=>{o(!0),s(!0),u(!1),l(b)},v=b=>{o(!0),u(!0),l(b)},x=()=>{o(!1)};return c.jsxs(hs,{children:[c.jsx(gs,{children:n("today")}),(e==null?void 0:e.length)>0&&c.jsx(vs,{children:e.slice().sort((b,y)=>Ne(b.time).getTime()-Ne(y.time).getTime()).map(b=>c.jsxs(xs,{children:[c.jsx(nn,{data:b}),c.jsxs(bs,{children:[c.jsx(ys,{type:"button",onClick:()=>p(b),children:c.jsx("svg",{children:c.jsx("use",{href:`${X}#icon-icon-pencil`})})}),c.jsx(ws,{type:"button",onClick:()=>v(b),children:c.jsx("svg",{children:c.jsx("use",{href:`${X}#icon-trash`})})})]})]},b.id))}),c.jsxs(Es,{onClick:d,type:"button",children:[c.jsx("span",{children:"+"}),n("addEditWaterModal.headerAdd")]}),a?c.jsx(ms,{isOpen:i,onClose:x,selectedItemId:r==null?void 0:r.id}):c.jsx(jn,{isOpen:i,onClose:x,isEditing:t,selectedItemId:r==null?void 0:r.id,amountWater:r==null?void 0:r.amount,date:r==null?void 0:r.time})]})},Ss=M("div")`
  ${st}
  display: flex;
  flex-direction: column;
  row-gap: 24px;
...
`,Ns=()=>{const{t:n}=re(),e=z(Le),o=(z(Be)/1e3).toFixed(1),[t,s]=g.useState(!1),a=()=>{s(!t)};return c.jsxs(Vs,{lang:e,children:[c.jsx(de,{children:n("dailyNormaModal.header")}),c.jsxs(js,{children:[c.jsxs("span",{children:[o," L"]}),c.jsx("button",{onClick:a,type:"button",children:n("dailyNormaModal.edit")})]}),c.jsx(Ps,{isOpen:t,onClose:a})]})},Ls=M("div")`
display: flex;
flex-direction:column;
row-gap:20px;
@media only screen and (min-width: 768px) {
...
`,Gs=()=>{const{t:n}=re(),e=z(Be),{allAmountForDay:i=0}=z(De),o=i/e*100,t=parseFloat(o).toFixed(0),[s,a]=g.useState(!1),u=()=>{a(!s)};return c.jsxs("div",{children:[c.jsxs(Ls,{children:[c.jsxs(Rs,{children:[c.jsx("p",{children:n("today")}),c.jsxs(Bs,{children:[c.jsx(Ws,{onChange:()=>{},name:"volume",type:"range",min:"0",max:"100",value:`${t}`,persent:t}),c.jsx($s,{children:"0%"}),c.jsxs(zs,{persent:t,children:[t,"%"]}),c.jsx(Hs,{children:"100%"})]})]}),c.jsxs(Ts,{onClick:u,children:[c.jsx("svg",{children:c.jsx("use",{href:`${X}#icon-circle-plus`})}),n("addEditWaterModal.headerAdd")]})]}),c.jsx(jn,{isOpen:s,onClose:u})]})},_s=$.div`
  display: flex;
  flex-wrap: wrap;
`,Us=$.div`
  position: relative;
...
`,au="/water-tracker/assets/bg-56863a63.png",ru="/water-tracker/assets/bottle-b9ff448c.png",du=()=>c.jsx(c.Fragment,{children:c.jsxs(Qs,{children:[c.jsxs(Kn,{children:[c.jsxs(Js,{children:[c.jsxs(eu,{children:[c.jsxs(tu,{children:[c.jsx(Ns,{}),c.jsx("img",{src:ru,alt:"bg"})]}),c.jsx(Gs,{})]}),c.jsxs(iu,{children:[c.jsx(Cs,{}),c.jsx(eo,{})]})]}),c.jsx(nu,{children:c.jsx(Ks,{children:"Delete user"})}),c.jsx(ou,{children:c.jsx(Qn,{})})]}),c.jsx(Zs,{src:au,alt:"bg"})]})});export{du as default};
