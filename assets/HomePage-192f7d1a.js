...
`,Qi="yyyy",Zi="MMMM",Ji="d",eo=()=>{const{t:n}=re(),e=z(Le),{waterForMonth:i=[]}=z(_i),o=z(De),t=z(Be),{allAmountForDay:s=0}=z(De),[a,u]=g.useState(0),r=s/t*100,l=parseFloat(r).toFixed(0);g.useEffect(()=>{u(l)},[t,s,o,l]);const[d,p]=g.useState(new Date),[v,x]=g.useState(null),b=g.useRef(null),w=ei(d),m=ti(d),f=Jn({start:w,end:m});let y=[];i.length>0&&(y=i==null?void 0:i.reduce((S,h)=>(S[h.date]=h,S),{}));let E;e==="uk"?E=_(d,"LLLL",{locale:tn}):E=_(d,Zi);const M=_(d,Qi),I=()=>{const S=ni(d,1);p(S),Et(S,new Date)?x(null):x("prev")},C=()=>{const S=Zt(d,1);p(S),Et(S,new Date)?x(null):x("next")};return c.jsxs("div",{ref:b,children:[c.jsxs(Yi,{children:[c.jsx(Xi,{children:n("month")}),c.jsxs(qi,{children:[c.jsx(Ct,{onClick:I,active:v==="next",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${q}#icon-pagination-arrow-prev`})})}),c.jsxs("span",{children:[E,", ",M]}),c.jsx(Ct,{onClick:C,active:v==="prev",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${q}#icon-pagination-arrow-next`})})})]})]}),c.jsx(Ki,{children:f.map(S=>{const h=_(S,"d, MMMM"),A=y[h]||0,P=A?parseInt(A.percentageWater):0,R=A?A&&parseInt(A.percentageWater)>=100:!1;return c.jsx(Ui,{isConsumed:R,date:_(S,Ji),percentage:P,day:h,calendarRef:b,data:y,today:{todayWaterData:o,dailyNormaFullfilled:a}},h)})})]})},to=F("div")`
display: flex;
align-items: center;
column-gap:12px;
svg {
...
`,Ns=()=>{const{t:n}=re(),e=z(Le),o=(z(Be)/1e3).toFixed(1),[t,s]=g.useState(!1),a=()=>{s(!t)};return c.jsxs(Vs,{lang:e,children:[c.jsx(de,{children:n("dailyNormaModal.header")}),c.jsxs(js,{children:[c.jsxs("span",{children:[o," L"]}),c.jsx("button",{onClick:a,type:"button",children:n("dailyNormaModal.edit")})]}),c.jsx(Ps,{isOpen:t,onClose:a})]})},Ls=F("div")`
display: flex;
flex-direction:column;
row-gap:20px;
@media only screen and (min-width: 768px) {
