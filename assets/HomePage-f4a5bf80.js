...
`,_i=({isConsumed:n,date:e,percentage:i,day:o,data:t,calendarRef:s})=>{const a=q(Ne),[l,r]=v.useState(null),[u,p]=v.useState(null),d=v.useRef(null),h=g=>{d.current&&!d.current.contains(g.target)&&r(null)};v.useEffect(()=>(document.addEventListener("click",h),()=>{document.removeEventListener("click",h)}),[]);const y=g=>{r(m=>m===g?null:g);const x=t[g]||0;a==="uk"&&(g=U(g,"d, MMMM",{locale:Jt})),p({date:g,dailyNorm:x?x.dailyNorm:0,totalWaterPortionsForDay:x?x.totalWaterPortionsForDay:0,percentageWater:x?parseInt(x.percentageWater):0})};return c.jsxs($i,{children:[c.jsx("div",{children:l&&c.jsx(Wi,{calendarRef:s,refData:d,waterData:u},o)}),c.jsx(Hi,{ref:d,onClick:()=>y(o),isConsumed:n,children:e}),c.jsxs(zi,{children:[i,"%"]})]})},Gi=S("div")`
margin-bottom: 16px;
display: flex;
...
`,Xi=n=>n.auth.user.waterRate,en=n=>n.water.today,Ki=n=>n.water.month,Qi="yyyy",Zi="MMMM",Ji="d",eo=()=>{const{t:n}=re(),e=q(Ne),{waterForMonth:i=[]}=q(Ki),[o,t]=v.useState(new Date),[s,a]=v.useState(null),l=v.useRef(null),r=Jn(o),u=ei(o),p=Zn({start:r,end:u});let d=[];i.length>0&&(d=i==null?void 0:i.reduce((m,f)=>(m[f.date]=f,m),{}));let h;e==="uk"?h=U(o,"LLLL",{locale:Jt}):h=U(o,Zi);const y=U(o,Qi),g=()=>{const m=ti(o,1);t(m),bt(m,new Date)?a(null):a("prev")},x=()=>{const m=Kt(o,1);t(m),bt(m,new Date)?a(null):a("next")};return c.jsxs("div",{ref:l,children:[c.jsxs(Gi,{children:[c.jsx(Yi,{children:n("month")}),c.jsxs(Ui,{children:[c.jsx(yt,{onClick:g,active:s==="next",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${Q}#icon-pagination-arrow-prev`})})}),c.jsxs("span",{children:[h,", ",y]}),c.jsx(yt,{onClick:x,active:s==="prev",type:"button",children:c.jsx("svg",{children:c.jsx("use",{href:`${Q}#icon-pagination-arrow-next`})})})]})]}),c.jsx(qi,{children:p.map(m=>{const f=U(m,"d, MMMM"),w=d[f]||0,E=w?parseInt(w.percentageWater):0,D=w?w&&parseInt(w.percentageWater)>=100:!1;return c.jsx(_i,{isConsumed:D,date:U(m,Ji),percentage:E,day:f,calendarRef:l,data:d},f)})})]})},to=S("div")`
display: flex;
align-items: center;
column-gap:12px;
svg {
...
`,Cs=()=>{const{t:n}=re(),{portionsOfWater:e}=q(en),[i,o]=v.useState(!1),[t,s]=v.useState(!1),[a,l]=v.useState(!1),[r,u]=v.useState(null),p=()=>{o(!0),s(!1),l(!1),u(null)},d=g=>{o(!0),s(!0),l(!1),u(g)},h=g=>{o(!0),l(!0),u(g)},y=()=>{o(!1)};return c.jsxs(hs,{children:[c.jsx(gs,{children:n("today")}),(e==null?void 0:e.length)>0&&c.jsx(vs,{children:e.slice().sort((g,x)=>Le(g.time).getTime()-Le(x.time).getTime()).map(g=>c.jsxs(xs,{children:[c.jsx(tn,{data:g}),c.jsxs(bs,{children:[c.jsx(ys,{type:"button",onClick:()=>d(g),children:c.jsx("svg",{children:c.jsx("use",{href:`${Q}#icon-icon-pencil`})})}),c.jsx(ws,{type:"button",onClick:()=>h(g),children:c.jsx("svg",{children:c.jsx("use",{href:`${Q}#icon-trash`})})})]})]},g.id))}),c.jsxs(Es,{onClick:p,type:"button",children:[c.jsx("span",{children:"+"}),n("addEditWaterModal.headerAdd")]}),a?c.jsx(ms,{isOpen:i,onClose:y,selectedItemId:r==null?void 0:r.id}):c.jsx(Vn,{isOpen:i,onClose:y,isEditing:t,selectedItemId:r==null?void 0:r.id,amountWater:r==null?void 0:r.amount,date:r==null?void 0:r.time})]})},Ss=S("div")`
${ot}
display: flex;
flex-direction:column;
row-gap:24px;
...
`,Ns=()=>{const{t:n}=re(),e=q(Ne),o=(q(Xi)/1e3).toFixed(1),[t,s]=v.useState(!1),a=()=>{s(!t)};return c.jsxs(Vs,{lang:e,children:[c.jsx(de,{children:n("dailyNormaModal.header")}),c.jsxs(Ls,{children:[c.jsxs("span",{children:[o," L"]}),c.jsx("button",{onClick:a,type:"button",children:n("dailyNormaModal.edit")})]}),c.jsx(Ps,{isOpen:t,onClose:a})]})},js=S("div")`
display: flex;
flex-direction:column;
row-gap:20px;
@media only screen and (min-width: 768px) {
